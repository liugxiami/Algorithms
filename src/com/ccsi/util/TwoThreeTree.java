...
public class TwoThreeTree <K extends Comparable<K>, V> {
    ...
    class FourNode extends Node
    {
        ...
        {
            super(keyValues1, keyValues2);  //super的用法
    ...
    private class KeyValuePair {
        ...
        public boolean equals(KeyValuePair o)
        {
    ...
    {
        //Search for our key.
        Node searchResult = getNode(key, root);
    ...
    private Node getNode(K key, Node startNode)
    {
        ...
        if (startNode.keyvalues2 == null)
        {
            ...
            return getNode(key, startNode.middle); //Middle is right child for TwoNodes.
        }
        else //ThreeNode
        {
    ...
    public void put(K key, V value)
    {
        ...
        else //If the node is a ThreeNode, then it's more complicated. Create a temporary FourNode, split it to a TwoNode and merge that back into the tree.
        {
            ...
            else if (key.compareTo(foundNode.keyvalues1.key) >0 && key.compareTo(foundNode.keyvalues2.key) <0)
            ...
            else if (key.compareTo(foundNode.keyvalues2.key) >0)
